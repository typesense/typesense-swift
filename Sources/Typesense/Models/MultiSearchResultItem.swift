...
public struct MultiSearchResultItem: Codable {
    ...
    public init(facetCounts: [FacetCounts]? = nil, found: Int? = nil, foundDocs: Int? = nil, searchTimeMs: Int? = nil, outOf: Int? = nil, searchCutoff: Bool? = nil, page: Int? = nil, groupedHits: [SearchGroupedHit]? = nil, hits: [SearchResultHit]? = nil, requestParams: SearchRequestParams? = nil, conversation: SearchResultConversation? = nil, unionRequestParams: [SearchRequestParams]? = nil, metadata: [String: AnyCodable]? = nil, code: Int64? = nil, error: String? = nil) {
