...
public struct CollectionSchema: Codable {
    ...
    public init(name: String, fields: [Field], defaultSortingField: String? = "", tokenSeparators: [String]? = nil, synonymSets: [String]? = nil, enableNestedFields: Bool? = false, symbolsToIndex: [String]? = nil, voiceQueryModel: VoiceQueryModelCollectionConfig? = nil, metadata: AnyCodable? = nil) {
        self.name = name
        self.fields = fields
