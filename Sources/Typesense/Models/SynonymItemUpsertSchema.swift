...
public struct SynonymItemUpsertSchema: Codable {
    ...
    public init(synonyms: [String], root: String? = nil, locale: String? = nil, symbolsToIndex: [String]? = nil) {
