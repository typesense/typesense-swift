...
public struct ConversationModelCreateSchema: Codable {
    ...
    public init(historyCollection: String, maxBytes: Int, modelName: String, accountId: String? = nil, apiKey: String? = nil, id: String? = nil, systemPrompt: String? = nil, ttl: Int? = nil, vllmUrl: String? = nil) {
