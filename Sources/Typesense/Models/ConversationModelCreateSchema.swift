...
public struct ConversationModelCreateSchema: Codable {
    ...
    public init(accountId: String? = nil, apiKey: String? = nil, historyCollection: String, id: String? = nil, maxBytes: Int, modelName: String, systemPrompt: String? = nil, ttl: Int? = nil, vllmUrl: String? = nil) {
