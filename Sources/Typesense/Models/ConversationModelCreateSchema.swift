...
public struct ConversationModelCreateSchema: Codable {
    ...
    public init(id: String? = nil, modelName: String, apiKey: String? = nil, historyCollection: String, accountId: String? = nil, systemPrompt: String? = nil, ttl: Int? = nil, maxBytes: Int, vllmUrl: String? = nil) {
        self.id = id
